...
export function VideoCallBox({ open, onOpenChange }: Props) {
  ...
  return (
    <Draggable
      ...
      cancel="button,a,video,.resize-corner"
      defaultPosition={{ x: 24, y: 92 }}
    >
      <div
        ref={nodeRef}
        className="absolute left-0 top-0 z-40 min-h-[360px] w-[430px] min-w-[300px] max-w-[calc(100vw-2rem)] resize overflow-auto border-4 border-black bg-[#f6bfd8] p-2 text-black shadow-[8px_8px_0_rgba(0,0,0,0.25)]"
      >
        ...
        <div className="border-4 border-black bg-white">
          ...
          <div className="grid grid-cols-[1fr_34px] grid-rows-[1fr_34px] bg-[#f6d8e6]">
            ...
            <div className="resize-corner border-l-4 border-t-4 border-black bg-[#f6d8e6]" />
          </div>
        </div>
      </div>
    </Draggable>
